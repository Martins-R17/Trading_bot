...
def print_table(records: list[dict[str, Any]], path: Path, ignored_count: int = 0, symbol_filter: str = "") -> None:
    ...
    for record in records:
        ...
        values = (
            ...
            truncate(str(summary.get("data_coverage") or "n/a"), 16),
            truncate(str(summary.get("data_start") or summary.get("data_period_start") or "n/a"), 10),
            truncate(str(summary.get("data_end") or summary.get("data_period_end") or "n/a"), 10),
